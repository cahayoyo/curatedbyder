    ...
    <form onSubmit={onSubmit} className="space-y-4 rounded-lg border p-4">
      ...
      <div className="space-y-2">
        ...
        {items.map((item, idx) => (
          <div
            key={idx}
            className="space-y-2 rounded-lg border border-input bg-white/50 p-3 sm:grid sm:grid-cols-[110px_1fr_90px_150px_130px_110px_auto] sm:items-end sm:gap-2 sm:space-y-0 sm:border-0 sm:bg-transparent sm:p-0"
          >
